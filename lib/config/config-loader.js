...
async function loadConfigFile(filePath) {
    ...
    if (ext === ".js" || ext === ".cjs") {
        ...
        try {
            ...
            // If require() fails for ESM files, fall back to dynamic import
            if (requireErr.code === "ERR_REQUIRE_ESM" ||
                requireErr.code === "ERR_REQUIRE_ASYNC_MODULE") {
        ...
        // Unwrap ESM interop: require() of an ESM .js may return {default: ...}
        if (loaded && loaded.__esModule && loaded.default !== undefined) {
